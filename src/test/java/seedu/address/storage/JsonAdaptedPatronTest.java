...
public class JsonAdaptedPatronTest {
    ...
    public void toModelType_validPersonDetails_returnsPerson() throws Exception {
        JsonAdaptedPatron person = new JsonAdaptedPatron(BENSON);
        assertEquals(BENSON, person.toModelType());
    }

    @Test
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPatron person =
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedPatron person = new JsonAdaptedPatron(null, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedPatron person = new JsonAdaptedPatron(VALID_NAME, null, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedPatron person = new JsonAdaptedPatron(VALID_NAME, VALID_PHONE, null, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedPatron person = new JsonAdaptedPatron(VALID_NAME, VALID_PHONE, VALID_EMAIL, null, VALID_TAGS);
